...
const MENU_CATALOG = [
  ...
  ["artisanBread", "kaya-jam-butter-baguette", "Kaya Jam Butter Baguette"],
  ["artisanBread", "peach-cream-cheese-ciabatta", "Peach Cream Cheese Ciabatta"],
  ["artisanBread", "basil-tomato-olive-cheese-ciabatta", "Basil Tomato Olive Cheese Ciabatta"],
  ["artisanBread", "plain-ciabatta", "Plain Ciabatta"],
